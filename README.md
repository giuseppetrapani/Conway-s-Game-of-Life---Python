...
- Regole standard del gioco: Implementa fedelmente le quattro regole del Game of Life.
- Animazione nel terminale: La griglia viene aggiornata in tempo reale senza stampare nuove schermate.
- Modello di Gosper Glider Gun: Include un modello predefinito che genera glider all'infinito, garantendo una simulazione a lunghissimo termine.
